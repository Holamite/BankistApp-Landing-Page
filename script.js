...
// I INTENTIONALLY COMMENT OUT THIS PAGE FOR SOME RESON, IT CAN BE REUSED
...
//   if (link.classList.contains('nav__link')) header.classList.toggle('nav-open');
// };
...
// // headerObserver.observe(header__title);
...
document.getElementById('sectiion--1');
...
//   alert('onmousecenter: Great! You are reding the heading :D');
// };
